...
def fill_in_hours(hours_sh):
    ...
    for i in range(48):
        ...
        time_bools.append(not open_bool if half_hour in hours_sh else open_bool)
...
def convert_properties():
    ...
    for restaurant in restaurants:
        ...
        for day in range(7): # days per week
            day_schedule = days_dict[day]
            hours_list = fill_in_hours(day_schedule)
...
restaurants = [
    ...
    ["Lone Star", 8, 4, 2, ["gluten"], False, ["indoor"], ["bike", "vehicle"]
     , ["take-out", "eat-in", "delivery"],{0:[11, 22]}],
    ["Tommy's", 4, 4, 1, ["gluten"], True, ["indoor", "outdoor"], ["bike", "vehicle"]
     , ["take-out", "eat-in", "delivery"], {0:[8, 2]}]
]
